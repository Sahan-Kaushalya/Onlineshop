...
if ($num > 0) {
    ...
    try {
        ...
        $mail->Username = 'hashinicooray7@gmail.com';                     //SMTP username
        $mail->Password = 'tukmfustqhhekdiy';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('hashinicooray7@gmail.com', 'Online Store');
                    ...
                    <table style="max-width: 600px;">
                        ...
                        <tr>
                            <td>
                                ...
                                <p style="margin-bottom: 24px;">You can change your password by clicking tje button below.</p>
                                <div>
                                ...
                                <p style="margin-top: 24px;">If you didn\'t ask to reset your password, you can ignore this.</p>
                                <hr>
                            </td> 
                        </tr>
                            <td align="center">
                                <p style="font-weight: 500;">&copy; 2024 OnlineStore.lk || All Rights Reserved</p>
                            </td>
                        <tr>
