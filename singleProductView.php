...
if (isset($stockId)) {
    ...
    ON `product`.`size_size_id`=`size`.`size_id` WHERE `stock`.`stock_id`='".$stockId."'";
    ...
    <body>
        ...
        <div class="adminBody">
            <div class="col-8 row shadow-lg p-5 bg-body-tertiary rounded-2 m-auto">
                <div class="col-6">
                    <img src="<?php echo $d["path"]; ?>" class="rounded-3 shadow-lg" width="320">
                </div>
                <div class="col-6">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button class="btn btn-outline-primary col-6" onclick="addCart('<?php echo $d['stock_id']; ?>');">Add to Cart</button>
